...
const Hero = () => {
  return (
    <>
      {/*Hero Section*/}
      <section className="py-xl-8 py-6 mt-5 mb-5">
        <div className="container py-xl-6 mb-5 ">
          <div className="row align-items-center gy-6 gy-xl-0">
            <div className="col-lg-5 col-xxl-5 col-12">
              <div className="d-flex flex-column gap-5">
                <div className="d-flex flex-row gap-2 align-items-center small">
                  <span>🚀</span>
                ...
                <div className="d-flex flex-column gap-3">
                  <div className="d-flex flex-column gap-2">
                    <h1
                      className="mb-0 display-4 fw-bolder"
                      style={{ color: "#1e293b" }}
                    >
                      The #1 Courses Learning Platform
                    </h1>
                    <p className="mb-0 text-secondary">
                      Hands-on training, and certifications to help you get the
                      most from Geeks Learning.
                    </p>
                  </div>
                ...
                <div className="d-grid d-md-flex flex-row gap-2">
                  <a
                    href="/signup"
                    className=" fw-medium btn  btn-lg text-white"
                  ...
                  <a
                    href="#!"
                    className="fw-medium btn btn-outline-secondary btn-lg"
                  >
                    Explore Courses
                  </a>
                </div>
            ...
            <div className="col-xxl-6 offset-xxl-1 col-lg-7 col-12">
              <div className="row gx-0 gy-4 gy-lg-0">
                  ...
                  <div className="position-relative me-n7">
                    <div className="position-absolute bottom-25 start-0 ms-n8 end-0 d-flex flex-column align-items-start">
                      <div className="bg-white rounded-pill py-2 px-3 shadow mb-2 d-inline-block">
                        ...
                        <span className="text-dark fw-medium">50+ Courses</span>
                      </div>
                      <div className="bg-white rounded-pill py-2 px-3 shadow mb-2 d-inline-block">
                        <svg
                          width={24}
                ...
                <div className="col-md-6 mt-8 mt-md-0">
                  ...
                  >
                    <img
                      src={require("../../src/images/Person 5.png")}
                      alt=""
                ...
                <div className="col-md-6 flex-column justify-content-end d-none d-md-flex">
                  ...
                  >
                    <img
                      src={require("../../src/images/Person 6.png")}
                      alt=""
                ...
                <div className="col-md-6 d-none d-md-block">
                  <div className="position-relative mt-5">
                    ...
                    <div className="bg-white rounded-4 p-3 position-absolute bottom-10 start-10  shadow">
                      <div className="avatar-group">
                        <span className="avatar avatar-md">
                          {/* avatar  */}
                          <img
                            alt="avatar"
                            src={require("../../src/images/Person 1.jpg")}
                        ...
                        <span className="avatar avatar-md">
                          <img
                            alt="avatar"
                            src={require("../../src/images/Person 2.jpg")}
                            className="rounded-circle"
                          />
                        </span>
                        {/* avatar  */}
                        <span className="avatar avatar-md">
                          <img
                            alt="avatar"
                            src={require("../../src/images/Person 3.jpg")}
                            className="rounded-circle"
                          />
                        </span>
                        {/* avatar  */}
                        <span className="avatar avatar-md">
                          <img
                            alt="avatar"
                            src={require("../../src/images/Person 4.jpg")}
                            className="rounded-circle"
                          />
                        </span>
                      </div>
                      <div className="text-dark fw-semibold fs-6 mt-1">
                        70,324+
                      </div>
